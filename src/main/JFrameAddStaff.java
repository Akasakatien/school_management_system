...
public class JFrameAddStaff extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrameAddStaff frame = new JFrameAddStaff();
	...
	public JFrameAddStaff() {
		...
		tabbedPane.setBounds(25, 82, 1072, 604);
		...
		jTextFieldNameStaff.setBackground(SystemColor.controlHighlight);
		...
		jButtonSavePersonalInfor.setBounds(469, 487, 147, 40);
		...
		jPanelFamilyInformation.setForeground(new Color(211, 211, 211));
		...
		scrollPane.setBounds(18, 13, 1033, 186);
		jPanelFamilyInformation.add(scrollPane);
		
		jTableFamilyInfor = new JTable();
		jTableFamilyInfor.setShowHorizontalLines(true);
		jTableFamilyInfor.setSelectionBackground(Color.BLACK);
		jTableFamilyInfor.setRowHeight(20);
		jTableFamilyInfor.setGridColor(Color.GRAY);
		jTableFamilyInfor.setForeground(new Color(211, 211, 211));
		jTableFamilyInfor.setFont(new Font("SansSerif", Font.PLAIN, 15));
		jTableFamilyInfor.setFillsViewportHeight(true);
		jTableFamilyInfor.setBackground(Color.DARK_GRAY);
		...
		scrollPane_1.setBounds(20, 13, 1032, 192);
		...
		scrollPane_2.setBounds(16, 13, 1035, 189);
		...
		scrollPane_3.setBounds(21, 13, 1028, 186);
		...
		button.setBounds(876, 699, 107, 35);
	...
	public void jButtonSavePersonalInforActionPerformed(ActionEvent event) {
		...
		idStaff = staff.getId();
		JOptionPane.showMessageDialog(null, "Add new staff successful");
	}
	...
	public void loadDataToFamily() {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		StaffDAO staffDAO = new StaffDAO();
		Staff staff = staffDAO.find(idStaff);
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		defaultTableModel.addColumn("ID");
		defaultTableModel.addColumn("Name");
		defaultTableModel.addColumn("Relation");
		...
		for(StaffFamily staffFamily : staff.getStaffFamilies()){
			defaultTableModel.addRow(new Object[]{
					staffFamily.getFamilyId(), staffFamily.getName(), staffFamily.getRelation(), dateFormat.format(staffFamily.getDateOfBirth()), staffFamily.getJob(), staffFamily.getAddress(),
					staffFamily.getPhoneNumber(), staffFamily.getEmail()});
		}
		jTableFamilyInfor.setModel(defaultTableModel);
	}
	...
	public void jButtonSaveFamilyActionPerformed(ActionEvent event) {
		...
		StaffDAO staffDAO = new StaffDAO();
		Staff staff = staffDAO.find(idStaff);
		StaffFamily staffFamily = new StaffFamily();
		...
		staffFamily.setRelation(jComboBoxRelation.getSelectedItem().toString());
		ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory();
		Validator validator = validatorFactory.getValidator();
		...
		staffFamilyDAO.create(staffFamily);
	...
	public void jButtonSaveEducationalActionPerformed(ActionEvent event) {
		...
		educationalDAO.create(educational);
		JOptionPane.showMessageDialog(null, "Add new Educational successfull");
		loadDataToEducational();
		jTextFieldNameOfUniverOrInstitute.setText("");
		jTextFieldYearOfEducation.setText("");
	...
	public void jButtonSaveExperienceActionPerformed(ActionEvent event) {
		StaffDAO staffDAO = new StaffDAO();
		Staff staff = staffDAO.find(idStaff);
		StaffExperience staffExperience = new StaffExperience();
		...
		staffExperienceDAO.create(staffExperience);
		JOptionPane.showMessageDialog(null, "Add new Experience successfull");
		loadDataToExperience();
		jTextFieldNameOfWorkplace.setText("");
		jTextFieldYearWorking.setText("");
		jTextFieldPosition.setText("");
		jTextFieldAchievement.setText("");
	}
	public void jButtonSavePromotionActionPerformed(ActionEvent event) {
		...
		JOptionPane.showMessageDialog(null, "Add new Promotion successfull");
		loadDataToPromotion();
		jTextFieldNameOfPosition.setText("");
		jTextFieldAchievementPromotion.setText("");
	}
}
